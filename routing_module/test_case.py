...
assert len(map1._links) == 5, "неверное число связей в списке _links класса Graph"
assert len(map1._nodes) == 5, "неверное число вершин в списке _nodes класса Graph"
